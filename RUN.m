...
num_mix_per_test_part = 52;
num_clean_sent_per_train_part = 52;
num_mix_per_train_part = num_clean_sent_per_train_part * repeat_time;


%% start DNN based azimuth and distance estimation
...
if is_gen_feat == 1
	...
	% test features
% 	total(feat_line, noise_line, -1, 1, 29*num_mix_per_test_part, mix_db, is_ratio_mask, TMP_DIR_STR);
	% training features
% 	total(feat_line, noise_line, 1, 1, 29*num_mix_per_train_part, mix_db, is_ratio_mask, TMP_DIR_STR);
end
