...
noise_line = 'BinauralLargeCrowdNoise' %noise type
...
test_list = ['config' filesep 'listroom516.txt'];
train_list = ['config' filesep 'listroom516.txt'];
% test_list = ['config' filesep 'listroom503.txt'];
